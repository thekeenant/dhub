...
public class ReplyTxn<R extends InboundMessage> extends Transaction {
    ...
    public ReplyTxn(Controller controller, Message message, MessageParser<R> parser) {
        super(controller);
    ...
    @Override
    public ReplyTxn<R> await() {
        super.await();
        return this;
    }

    @Override
    public ReplyTxn<R> await(int timeout) {
        super.await(timeout);
        return this;
    }
