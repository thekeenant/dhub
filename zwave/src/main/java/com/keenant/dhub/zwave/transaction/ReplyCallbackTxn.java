...
public class ReplyCallbackTxn<R extends InboundMessage, C extends InboundMessage> extends Transaction {
    ...
    public ReplyCallbackTxn(Controller controller, Message<?> message, MessageParser<R> replyParser, MessageParser<C> callbackParser) {
        super(controller);
    ...
    @Override
    public ReplyCallbackTxn<R, C> await() {
        super.await();
        return this;
    }

    @Override
    public ReplyCallbackTxn<R, C> await(int timeout) {
        super.await(timeout);
        return this;
    }
